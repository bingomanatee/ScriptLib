...
(function()
{
	...
	CKEDITOR.dialog.prototype =
	{
		...
		hide : function()
		{
			...
			if ( !this._.parentDialog )
			{
				...
				// Remove bubbling-prevention handlers. (#4269)
				for ( var event in { keyup :1, keydown :1, keypress :1 } )
	...
	(function()
	{
		CKEDITOR.ui.dialog =
		{
			 ...
			 * 	probably more letters is an event handlers. Event handlers may be further
	...
	CKEDITOR.ui.dialog.uiElement.prototype =
	{
		 ...
		 *  	register the event handlers under the corresponding DOM event of
		...
		/**
		 * The default handlers for a UI element's access key down event, which
		...
		/**
		 * The default handlers for a UI element's access key up event, which
		 * does nothing.<br />
